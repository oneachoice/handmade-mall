...
public class PartnerProductController {
    ...
    public String deleteProduct(@PathVariable Long id) {
        productManagementService.removeProductById(id);
    ...
    public String viewProductListPage(Model model, @PageableDefault(sort = "createdAt", direction = Sort.Direction.DESC, size = 5, page = 0) Pageable pageable) {
        Page<ProductListItemDto> productListViewDtoPage = productManagementService.getProductListItemDtoPage(pageable);
    ...
    public String updateProduct(ProductDto productDto, Product product, ProductImage productImage) {
        //상품 수정 서비스 호출
        productManagementService.update(productDto);
    ...
    public String createProduct(ProductDto productDto) {
        ...
        productManagementService.createByProductDto(productDto);
