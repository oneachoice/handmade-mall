...
import newbies.handmade_mall.service.CheckoutCrudService;
import newbies.handmade_mall.service.CheckoutProductCrudService;
...
public class CustomerCheckoutCrudController {
    ...
    public String checkout(CheckoutDto checkoutDto, RedirectAttributes redirectAttributes){
        ...
        CheckoutProductViewDto  checkoutProductViewDto = productCrudService.viewCheckoutSuccessPage(checkoutProductDto.getCheckoutId(),checkoutDto.getProductId());
